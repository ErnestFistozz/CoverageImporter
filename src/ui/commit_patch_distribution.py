...
projects = ['ws-axiom', 'commons-collections',
            'commons-geometry', 'commons-lang',
            'commons-numbers', 'commons-rng',
            'commons-statistics',  'datasketches-java',
            'dolphinscheduler']

distibution_data = []
for project in projects:
    df = pd.read_csv('codecovdata.csv', encoding='utf-8', names=header_names)  
